...
formatter.match({
  "location": "AddEmloyeeSteps.i_am_logged_into_HRMS()"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "AddEmloyeeSteps.i_navigated_to_Add_Employee_Page()"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "AddEmloyeeSteps.i_add_and_(String,String,String)"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "AddEmloyeeSteps.i_click_Save()"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "AddEmloyeeSteps.i_see_Employee_has_been_succesfully_added()"
});
formatter.result({
  "status": "passed"
});
...
formatter.result({
  "error_message": "java.lang.AssertionError\n\tat org.junit.Assert.fail(Assert.java:86)\n\tat org.junit.Assert.assertTrue(Assert.java:41)\n\tat org.junit.Assert.assertTrue(Assert.java:52)\n\tat com.hrms.steps.LoginSteps.i_successfully_logged_in(LoginSteps.java:34)\n\tat ✽.I successfully logged in(file:src/test/resources/features/Login.feature:9)\n",
  "status": "failed"
});
formatter.step({
