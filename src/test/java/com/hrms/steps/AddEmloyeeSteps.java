...
public class AddEmloyeeSteps extends CommonMethods{
	String empId;
	...
	public void i_enter_employee_details(DataTable empDetails) {
		...
		for(Map<String, String> map:empDetailList) {
			sendText(addEmp.firsName , map.get("FirstName"));
