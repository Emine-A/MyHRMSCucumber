...
public class B_GetOneEmployeeAPISteps {
private Response response;
private static RequestSpecification request;
	
//given()- then() -.param- .body -.header -.-->come restassured
//Assert.asser   --> give junit
//equalTo        --> come from hamcrest.Matchers.equalTo
	...
	public void user_validates_created_employee_exists() {
	 ...
	 // Second way to assert
	 		...
	 		Assert.assertEquals("Verifying Employee IDs", A_POSTCreateEmployeeApi.employee_ID, actualyEmployeeID);
