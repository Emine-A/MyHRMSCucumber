...
public class D_GETVerifyUpdatedEmployee {
	...
	public void user_validates_updated_employee_exists() {
	 response.then().body("employee[0].employee_firstname",equalTo("student1")) ; 
	...
	try {
		Assert.assertEquals(A_POSTCreateEmployeeApi.employee_ID, actualEmployeeID);
